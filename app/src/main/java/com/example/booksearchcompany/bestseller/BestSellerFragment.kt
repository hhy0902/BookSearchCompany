...
class BestSellerFragment : Fragment(R.layout.fragment_bestseller){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentBestSellerBinding.leftButton.visibility = VISIBLE
        fragmentBestSellerBinding.rightButton.visibility = VISIBLE
    ...
    private fun searchBook() {
        ...
        retrofitService.getBestSellerItem(start.toString()).enqueue(object : Callback<BestSellerItem> {
